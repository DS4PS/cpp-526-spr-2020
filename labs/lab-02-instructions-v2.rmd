...
This lab uses [**city tax parcel data**](https://ds4ps.org/Data-Science-Class/DATA/syr_parcels.html), and open dataset released by the municipal government of Syracuse, NY. 
