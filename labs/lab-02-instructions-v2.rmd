...
URL <- "https://raw.githubusercontent.com/DS4PS/Data-Science-Class/master/DATA/downtown-syr.geojson"
downtown <- geojson_read( URL, what="sp" )
plot( downtown,  border=NA, col="gray80" )
```
...
#### 5. How many properties are delinquient on taxes? Map your results. 
...
#### 7. What proportion of commercial properties are delinquit on taxes? What proportion of delinquint tax bills are owed by commercial parcels? 
...
group.colors <- ifelse( these, "firebrick", "gray90" )    
plot( downtown,  border="gray70", col=group.colors,
      main="Tax Delinquint Commercial Properties")          

these <- downtown$landuse != "Commercial" & downtown$amtdelinqt > 0                     
group.colors <- ifelse( these, "steelblue", "gray90" )    
plot( downtown,  border="gray70", col=group.colors,
      main="Tax Delinquint Non-Commercial Properties")            
```
...
#### 7. How many of each land use type are delinquint on taxes? 

> **table()** with **amtdelinqt** and **landuse** variables
> define delinquincy first, then create a table with
> landuse and delinquincy
...
```{r}
public.goods  <-  downtown$land_use == "Community Services" | 
                  downtown$land_use == "Schools" | 
                  downtown$land_use == "Recreation"
